...
<div class="utama">
	...
	<span class="float-right">
		<form action="" method="post" class="form-inline">
			<button class="btn btn-success"  name="cari" id="tombol-cari" type="submit">Cari</button>
	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				<td><?php echo $no?></td>
				<td style="font-color: #fff;"><?php echo $row["nim"]?></td>
...
<script src="js/scriptMhs.js"> </script>
</body>
</html>	
