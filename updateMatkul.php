...
<html>
	...
	<body>
		...
		<div class="utama">
			...
			<div class="text-center"><a href="prnmtkPdf.php"><span class="fas fa-print">&nbsp;Print</span></a></div>
			...
			<span class="float-right">
				<form action="" method="post" class="form-inline">
					...
					<input class="form-control mr-2 ml-2" type="text" name="cari" placeholder="cari data matkul..." autofocus autocomplete="off" id="keyword">
				</form>
			</span>
			<br><br>
				...
				<tbody>
					...
					?>	
						<tr>
							...
							<td>
								<a class="btn btn-outline-primary btn-sm" href="editmatkul.php?idmatkul=<?php echo $row['idmatkul']?>">Edit</a>
								<a class="btn btn-outline-danger btn-sm" href="hpsmatkul.php?idmatkul=<?php echo $row["idmatkul"]?>" id="linkHps" onclick="return confirm('Yakin dihapus nih?')">Hapus</a>
							</td>
						</tr>
								<?php 
									$no++;
